...
Nodes are installed via PXE (see [Netboot.md](../../1-networking/Unifi/Networks/Netboot.md)). After each node is up:
...
ssh_public_key    = "ssh-ed25519 AAAA... homelab-datacenter"
```
