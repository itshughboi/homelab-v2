...
Nodes install via [Ventoy USB](provisioning/Ventoy.md) (netboot/PXE was [abandoned](../1-networking/Alternative%20Methods/Netboot/README.md)). After install, Ansible configures bridges/VLANs and joins the cluster; Terraform then provisions the VMs.
