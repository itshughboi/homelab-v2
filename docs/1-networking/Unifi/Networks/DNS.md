...
- Bind9 (`10.10.10.8`) is authoritative for `*.hughboi.cc` — answers these directly from zone files
...
| --- | --- | --- |
| Bind9 **primary** | Athena VM (pve-srv-1) | Trusted nets (authoritative for `*.hughboi.cc`) |
